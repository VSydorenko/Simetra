...
export const SECTION_CONFIG: Record<MetadataKind, SectionDef[]> = {
  Catalog: [
    { id: 'main', labelKey: 'metadata.section.main', icon: InformationCircleIcon },
    { id: 'data', labelKey: 'metadata.section.data', icon: Database02Icon },
    { id: 'numbering', labelKey: 'metadata.section.numbering', icon: HashtagIcon },
    { id: 'settings', labelKey: 'metadata.section.settings', icon: Settings02Icon },
  ],
  Document: [
    { id: 'main', labelKey: 'metadata.section.main', icon: InformationCircleIcon },
    { id: 'data', labelKey: 'metadata.section.data', icon: Database02Icon },
    { id: 'numbering', labelKey: 'metadata.section.numbering', icon: HashtagIcon },
    { id: 'movements', labelKey: 'metadata.section.movements', icon: Exchange01Icon },
    { id: 'settings', labelKey: 'metadata.section.settings', icon: Settings02Icon },
  ],
  Enumeration: [
    { id: 'main', labelKey: 'metadata.section.main', icon: InformationCircleIcon },
