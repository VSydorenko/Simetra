...
#### Tab Bar
- [Х] Tab Bar у верхній частині центральної панелі — горизонтальний рядок вкладок
- [Х] Кожна вкладка відображає: іконку типу, імʼя обʼєкта, dirty indicator (`*`), кнопку close (×)
- [Х] Операції з вкладками:
...
- [Х] Контекстне меню вкладки: Close, Close Others, Close All, Close to the Right, Pin/Unpin, Detach to Window
- [Х] Scroll на Tab Bar при великій кількості вкладок (горизонтальний scroll або кнопки ◀ ▶)
- [Х] Ctrl+W / Cmd+W — закрити активну вкладку
- [Х] Ctrl+Tab / Ctrl+Shift+Tab — переключення між вкладками
- [Х] Empty state коли немає відкритих вкладок: підказка "Оберіть обʼєкт у дереві для редагування"

#### Вміст картки обʼєкта
- [Х] Заголовок: імʼя обʼєкта (editable), badge типу, displayName
- [Х] Вкладки всередині картки (залежно від типу):
...
- [Х] Таблиця реквізитів через `@tanstack/react-table`:
...
- [Х] Inline editing для імені поля та типу
- [Х] Вибір типу поля з категоризованого dropdown: Примітивні / Посилальні / Перелічення
- [ ] Для посилальних типів — вибір цільового обʼєкта з dropdown (фільтрований за kind)
- [Х] Для регістрів — візуальне розділення Dimensions / Resources / Attributes (окремі секції або кольорові маркери)
- [Х] Вкладка "Значення" для Enumeration:
  - Таблиця: name (PascalCase), displayName {uk, en}, order
  - Кнопки: Додати, Видалити, Вгору, Вниз
- [Х] Empty state для кожної вкладки з підказкою що робити
- [Х] Вкладка "Налаштування" (Constant):
...
### Definition of Done
- [Х] Tab Bar з операціями: open, close, close others, pin, reorder
- [Х] Empty state при відсутності відкритих вкладок
- [ ] Per-tab dirty indicator
- [Х] Editor показує правильні вкладки для кожного типу
- [Х] Стандартні реквізити відображаються readonly
- [Х] CRUD атрибутів працює
- [Х] CRUD табличних частин працює
- [Х] CRUD значень enum працює
- [Х] Dimensions/Resources/Attributes для регістрів розділені
- [Х] Тип поля обирається з dropdown
- [ ] Посилальні типи мають вибір цільового обʼєкта
- [Х] Зміна порядку полів працює
- [Х] Усі labels через i18n
- [Х] `pnpm lint && pnpm typecheck` — green
